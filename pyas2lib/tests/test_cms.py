...
def test_signing():
    ...
    cms.sign_message(b"data", digest_alg="sha256", sign_key=sign_key, use_signed_attributes=False)
...
def test_encryption():
    ...
    enc_algorithms = ['rc2_128_cbc', 'rc4_128_cbc', 'aes_128_cbc', 'aes_192_cbc', 'aes_256_cbc']
